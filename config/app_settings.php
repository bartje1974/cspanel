...
return [
    ...
    'sections' => [
        ...
        'url' => [
            ...
            'descriptions' => 'Enter your domain name like https://domain.tld',
            'icon' => 'fa fa-globe',
            ...
            'inputs' => [
                [
                    ...
                    'type' => 'text',
                    'label' => 'Domain url',
                    'placeholder' => 'Application from domain',
                    'rules' => 'required',
                ],
            ]
        ],
        'server' => [
            'title' => 'your server settings',
            'descriptions' => 'Enter server settings',
            'icon' => 'fa fa-server',
            ...
            'inputs' => [
                ...
                [
                    'name' => 'from_ip',
                    'type' => 'text',
                    'label' => 'The ip adress from your server',
